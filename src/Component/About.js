...
export default function About() {
  ...
  const [btnText, setbtnText] = useState("Enable to darkness") 
  ...
  <div className="accordion-item">
    ...
    <div style={myStyle} id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
      <div className="accordion-body">
        <strong>This is the second item's accordion body.</strong> It have the all mortive of our project although is working on current project. then we all siscess all about in this page , ny HTML can go within the <code>.accordion-body</code>, though the transition does limit overflow.
      </div>
    </div>
  </div>
  <div className="accordion-item">
